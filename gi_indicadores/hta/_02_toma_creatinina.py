...
class TomaCreatininaHTA(AbstractIndicador):
    def __init__(self, **kwargs):
        super(TomaCreatininaHTA, self).__init__(
            **{
                "name": "Toma de creatinina",
                "slug": "toma-de-creatinina-hta",
                "description": "Pacientes con HTA con toma de Creatinina en los últimos 12 meses sobre el total de pacientes con HTA.",
                "label": "Tasa",
                "tipo": "HTA",
            }
        )
