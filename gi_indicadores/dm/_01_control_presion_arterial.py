...
from pandas import DataFrame, Timestamp, to_datetime, Timedelta
...
class ControlPresionArterial(AbstractIndicador):
    def __init__(self, **kwargs):
        super(ControlPresionArterial, self).__init__(
            **{
                "name": "Toma de presion arterial",
                "slug": "toma-presion-arterial-dm",
                "description": "Pacientes en control de presión arterial (menor a 140/90) sobre total de la cohorte.",
                "label": "Tasa",
                "tipo": "DM",
            }
        )
    ...
    def calc(self, **kwargs) -> DataFrame:
        ...
        return main[["Fecha", "variable", "valor", "flag"]].sort_values(
