...
class ControlLdl(AbstractIndicador):
    def __init__(self, **kwargs):
        super(ControlLdl, self).__init__(
            **{
                "name": "Toma de LDL",
                "slug": "toma-ldl-dm",
                "description": "Pacientes con toma de LDL en los últimos 12 meses sobre total de la cohorte.",
                "label": "Tasa",
                "tipo": "DM",
            }
        )
